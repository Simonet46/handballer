...
const es = {
  ...
  story: {
    opener: {
      inmortal: "Hay carreras que se estudian y carreras que se cuentan como leyendas: la de {name} es de las segundas.",
      icono: "Pocas historias explican mejor este deporte que la de {name}.",
      leyenda: "En su club todavía hay una camiseta que nadie más se anima a pedir: la de {name}.",
      idolo: "A {name} no le alcanzaron las vitrinas, pero le sobró tribuna.",
      trotamundos: "La de {name} fue una carrera de valija siempre lista.",
    },
    ...
    closer: {
      inmortal: "El handball sigue, claro. Pero hay números de camiseta que ya no se entregan.",
      icono: "Cuando se apagaron las luces, el aplauso siguió un rato largo.",
      leyenda: "Los pibes del club todavía preguntan por ese siete metros. Los grandes sonríen.",
      idolo: "No fue perfecto. Fue algo mejor: fue de la casa.",
      trotamundos: "Quizás no haya estatua. Pero preguntá en cualquier vestuario de Europa: todos tienen una anécdota.",
    },
  },
  events: {
    "doble-turno": {
...
const fr = {
  ...
  story: {
    opener: {
      inmortal: "Il y a des carrières qu'on étudie et d'autres qu'on raconte comme des légendes : celle de {name} est du deuxième genre.",
      icono: "Peu d'histoires racontent mieux ce sport que celle de {name}.",
      leyenda: "Au club, il y a encore un maillot que personne n'ose réclamer : celui de {name}.",
      idolo: "Les vitrines n'ont pas suffi à {name}, mais les tribunes ont débordé.",
      trotamundos: "La carrière de {name} fut celle d'une valise toujours prête.",
    },
    ...
    closer: {
      inmortal: "Le handball continue, bien sûr. Mais certains numéros ne se distribuent plus.",
      icono: "Quand les lumières se sont éteintes, les applaudissements ont continué un long moment.",
      leyenda: "Les gamins du club demandent encore ce jet de sept mètres. Les anciens sourient.",
      idolo: "Ce ne fut pas parfait. Ce fut mieux : ce fut quelqu'un de la maison.",
      trotamundos: "Pas de statue, peut-être. Mais demandez dans n'importe quel vestiaire d'Europe : tout le monde a une anecdote.",
    },
  },
  events: {
    "doble-turno": {
...
const de = {
  ...
  story: {
    opener: {
      inmortal: "Es gibt Karrieren, die man studiert, und solche, die man wie Legenden erzählt: die von {name} gehört zur zweiten Sorte.",
      icono: "Wenige Geschichten erklären diesen Sport besser als die von {name}.",
      leyenda: "Im Verein hängt noch ein Trikot, das sich niemand zu nehmen traut: das von {name}.",
      idolo: "Für {name} reichten die Vitrinen nicht — dafür bebte die Tribüne.",
      trotamundos: "Die Karriere von {name} war eine mit stets gepacktem Koffer.",
    },
    ...
    closer: {
      inmortal: "Der Handball geht weiter, klar. Aber manche Rückennummern werden nicht mehr vergeben.",
      icono: "Als das Licht ausging, hielt der Applaus noch lange an.",
      leyenda: "Die Jugendspieler fragen noch heute nach diesem Siebenmeter. Die Alten lächeln.",
      idolo: "Es war nicht perfekt. Es war besser: es war jemand von hier.",
      trotamundos: "Vielleicht gibt es keine Statue. Aber frag in irgendeiner Kabine Europas: alle haben eine Anekdote.",
    },
  },
  events: {
    "doble-turno": {
