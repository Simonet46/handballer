...
ALIASES = {
    ...
    "ABC Braga": "ABC de Braga Lusíadas Saúde",
    "Madeira SAD": "AM Madeira Andebol SAD",
    "Ferencvárosi TC": "FTC-Green Collect",
    "Gyöngyösi KK": "HEDO-B. Braun Gyöngyös",
    "Komlói BSK": "Sport36 - Komló",
    "Budakalász FKC": "CYEB Budakalasz",
    "Tatabánya KC": "MOL Tatabanya KC",
    "Stal Mielec": "Tauron Stal Mielec",
    "Chrobry Głogów": "KGHM Chrobry Glogow",
    "Azoty-Pulawy": "KS Azoty-Pulawy SA",
    "Zagłębie Lubin": "MKS \"Zaglebie\" Lubin",
    "Wybrzeże Gdańsk": "SPR Pogon Szczecin",
    "Steaua București": "CSA Steaua Bucuresti",
    "Politehnica Timisoara": "SCM Politehnica Timisoara",
    "RK Koper": "RD Koper",
    "RK Ribnica": "RD Riko Ribnica",
    "UHK Krems": "Förthof UHK Krems",
    "Fram Reykjavík": "Knattspyrnufélagið Fram",
    "FH Hafnarfjörður": "FH Hafnarfjordur",
    "Bækkelagets SK": "Baekkelaget Handball Elite",
    "Haslum HK": "Haslum Handballklubb",
    "IFK Skövde": "IFK Skövde HK",
    "Ystads IF": "Ystads IF HF",
    "Hammarby IF": "Hammarby Handboll",
    "HIF Karlskrona": "HF Karlskrona",
    "SønderjyskE Håndbold": "SonderjyskE Herrehandbold ",
    "KIF Kolding": "KIF Kolding Kobenhavn",
    "Aalborg Håndbold": "AaB Handball",
    "HSG Nordhorn-Lingen": "HSG Nordhorn",
    "Barça B": "Barça",
    "Arged KPR Ostrovia Ostrow": "Rebud KPR Ostrovia Ostrow Wlkp",
    "RK Krka": "MRK Krka",
    "RK Ohrid": "GRK Ohrid",
    "KA Akureyri": "KA",
}
